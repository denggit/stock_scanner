...
from backend.business.backtest_event import DataUtils, ReportUtils
from backend.business.backtest_event.core import BacktestEngine
from backend.business.backtest_event.database import ChannelDBAdapter
...
class BaseBacktestRunner:
    ...
    def __init__(
        ...
        self.logger = setup_logger(log_config.get('logger_name', 'backtest_event'), log_level=log_level)
