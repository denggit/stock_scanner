...
from backend.business.backtest_event.strategies.implementations.channel.rising_channel import \
    RisingChannelStrategy as RisingChannelBacktestStrategy
from backend.business.backtest_event.configs.rising_channel_config import RisingChannelConfig
