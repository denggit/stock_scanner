...
from backend.business.backtest_event.core.trading_rules import is_trade_blocked_by_price_limit, AShareTradingRules
...
class BaseStrategy(bt.Strategy):
    ...
    def __init__(self, stock_data_dict: Dict[str, pd.DataFrame] = None, effective_start_date: str | None = None,
        ...
        # 设置日志记录器
        self.logger = setup_logger("backtest_event")
    ...
    def execute_trades(self, signals: List[Dict[str, Any]]):
        ...
        if sell_signals:
            from backend.business.backtest_event.core.trading_rules import is_trade_blocked_by_price_limit
            ...
            for signal in buy_signals:
                try:
                    ...
                    if est_cost > remaining_budget:
                        from backend.business.backtest_event.core.trading_rules import AShareTradingRules
                        # 按手递减，直至满足预算或无法下单
