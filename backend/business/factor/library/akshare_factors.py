...
def institution_buy_sell_ratio(institution_buy_ratio: pd.Series, institution_sell_ratio: pd.Series,
                               **kwargs) -> pd.Series:
...
def institution_net_buy_ratio(institution_buy_ratio: pd.Series, institution_sell_ratio: pd.Series,
                              **kwargs) -> pd.Series:
    """机构净买入比率因子：机构净买入占比"""
...
def market_cap_ratio_factor(circulating_market_cap_akshare: pd.Series, total_market_cap_akshare: pd.Series,
                            **kwargs) -> pd.Series:
...
def institution_attention_factor(institution_participation: pd.Series, market_attention: pd.Series,
                                 **kwargs) -> pd.Series:
...
def valuation_quality_factor(pe_akshare: pd.Series, pb_akshare: pd.Series, comprehensive_score: pd.Series,
                             **kwargs) -> pd.Series:
    """估值质量因子：估值指标与综合评分的结合"""
...
def breakout_strength_factor(close: pd.Series, high: pd.Series, low: pd.Series, volume: pd.Series,
                             **kwargs) -> pd.Series:
    """突破强度因子：价格突破的强度"""
    # 计算突破强度
...
def institution_sentiment_factor(institution_participation: pd.Series, institution_buy_ratio: pd.Series,
                                 **kwargs) -> pd.Series:
